import { IntermediateText, IntermediateTextSerialized } from '@typesCommon/HamsterDocument/IntermediateText';
...
export class IntermediatePage implements IntermediatePageSerialized {
	...
	constructor(
		{ texts, width, height, number, id, thumbnail }: Omit<IntermediatePageSerialized, 'texts'> & { texts: IntermediateText [] }
	) {
		this.id = id;
		this.texts = texts;
		this.width = width;
